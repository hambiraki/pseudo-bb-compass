...
export const scoutor = {
    ...
    "ストーク偵察機": new WeaponOnMinimap(new Scoutor({mRadius:113, mpsSpeed:2.6, mDistance:50})),
    "アウル偵察機": new WeaponOnMinimap(new Scoutor({mRadius:142, mpsSpeed:14, mDistance:220})),
    "ロビン偵察機": new WeaponOnMinimap(new Scoutor({mRadius:220, mpsSpeed:20, mDistance:150})),
    "カナリア偵察機": new WeaponOnMinimap(new Scoutor({mRadius:266, mpsSpeed:25, mDistance:80})),
    "マグ": new WeaponOnMinimap(new Scoutor({mRadius:176, mpsSpeed:16, mDistance:180})),
};