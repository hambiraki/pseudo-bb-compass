...
export const brTracker = {
    "BRトラッカー": new BrTracker({mRadius:162, degCenter:90, sToFull:1.65, sRetention:3, sPause:2}),
    "集中型BRトラッカー": new BrTracker({mRadius:142, degCenter:120, sToFull:2.05, sRetention:2, sPause:2}),
    "広域型BRトラッカー": new BrTracker({mRadius:198, degCenter:150, sToFull:1.67, sRetention:6, sPause:2}),
};
