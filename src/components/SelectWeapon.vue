...
import { name2weapon } from "@/weapons";
import { computed, ref, type Ref } from "vue";

const selectedSeries: Ref<keyof typeof name2weapon> = ref("索敵センサー");
type SeriesName = keyof typeof name2weapon;
const seriesNames: SeriesName[] = Object.keys(name2weapon) as SeriesName[];
const modelNames = computed((): readonly string[] => {
  return Object.keys(name2weapon[selectedSeries.value]);
});
