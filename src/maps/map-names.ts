export const location2situation = new Map([
  ["スカービ渓谷", ["戦線突破", "砂上の激突"]],
  [
    "第３採掘島",
...
export type MapLocation =
  typeof location2situation.keys extends () => IterableIterator<infer K>
    ? K
    : never;
export type MapSituation = NonNullable<
  ReturnType<typeof location2situation.get>
> extends ReadonlyArray<infer K>
  ? K
  : never;
